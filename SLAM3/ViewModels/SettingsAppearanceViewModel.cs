...
namespace SLAM3.ViewModels
{
    public class SettingsAppearanceViewModel : NotifyPropertyChanged
    {
        ...
        private readonly Color[] accentColors =
        {
            ...
            Color.FromRgb(0x00, 0xbc, 0xff), Color.FromRgb(0x00, 0x82, 0xAD), Color.FromRgb(0x00, 0x50, 0xa9), Color.FromRgb(0x00, 0x50, 0xef),
            Color.FromRgb(0x00, 0x20, 0xdc), Color.FromRgb(0x00, 0x00, 0xef), Color.FromRgb(0x50, 0x00, 0xee), Color.FromRgb(0xaa, 0x00, 0xff),
